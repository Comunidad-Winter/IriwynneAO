...
Private Sub Image3_Click()
    ' @ Cui
    Call ShellExecute(0, "Open", "http://www.iriwynneao.com/", "", App.path, SW_SHOWNORMAL)
End Sub

Private Sub Image4_Click()
Call addConsole("Deshabilitado.", 0, 100, 255, True, False)
End Sub
